    ...
    while (@$worklist ||
        ...
        if (1 < $lcovutil::maxParallelism) {
            ...
            if ('file' eq $type) {
                ...
                main::write_summary_pages(1,    # this is a directory,
                                          $selfSummary, $main::show_details,
                                          $rel_dir, $base_dir, $trunc_dir,
                                          $perTestData);
                $parentSummary->append($selfSummary);
...
sub write_summary_pages($$$$$$$)
{
    my ($summaryType, $summary, $show_details, $rel_dir,
        $base_dir, $trunc_dir, $testhashes) = @_;
...
sub process_file($$$$$)
{
    ...
    if (!$no_sourceview) {
        ...
        if ($func_coverage) {
            ...
            $lcovutil::profileData{source}{$filename} = $to - $from;
        }
